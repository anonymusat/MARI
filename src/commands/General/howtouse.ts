...
export default class Command extends BaseCommand {
    constructor(client: WAClient, handler: MessageHandler) {
        super(client, handler, {
            ...
            category: 'general',
            usage: `${client.config.prefix}howtouse`
        })
    }

    run = async (M: ISimplifiedMessage): Promise<void> => {
        const n = [
            'https://i.pinimg.com/564x/f6/27/49/f627491dea600ab18dbd82cb94092d96.jpg'
        ]
...
📑 *A:* Asuna is one of the bots owned by *KING'S🈲* group. Incase you need other bots, use the command *!support* & you will get support group link in your DM.
ᚖ ────── ✪ ────── ᚖ
📮 *Q7:* Can you hire a bot from KING'S🈲?*
...
📑 *A:* You can't deploy a version of 🎀𝓜𝓐𝓡𝓘𝓝𝓔🎀. Therefore, you can deploy the main bot *(🎀𝓜𝓐𝓡𝓘𝓝𝓔🎀)* here👇
 🎗 https://github.com/DEVILL-MASCOT/marin.
ᚖ ────── ✪ ────── ᚖ
📮 *Q10:* Is the project or the *KING'S🈲* group sponsored?
